 ...
 */
final class Version20240711195618 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE history (id INT AUTO_INCREMENT NOT NULL, winner_id INT DEFAULT NULL, loser_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_27BA704B5DFCD4B8 (winner_id), UNIQUE INDEX UNIQ_27BA704B1BCAA5F6 (loser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE history_game (history_id INT NOT NULL, game_id INT NOT NULL, INDEX IDX_281E41F0E48FD905 (game_id), INDEX IDX_281E41F01E058452 (history_id), PRIMARY KEY(history_id, game_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
