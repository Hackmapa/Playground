...
class SnakeGame extends React.Component {
  ...
  tryToEatApple() {
    ...
    if (snake[0].Xpos === apple.Xpos && snake[0].Ypos === apple.Ypos) {
      ...
      // Apply animation class for eating apple
    this.appleRef.classList.add('apple-eaten');
    setTimeout(() => {
      this.appleRef.classList.remove('apple-eaten');
    }, 500);
    ...
    return (
      <div
        ...
        style={{
          ...
          height: this.state.height + this.state.height / 18,
        ...
        <div
          className='Block'
          ref={(appleRef) => (this.appleRef = appleRef)}
          style={{
            width: this.state.blockWidth,
            height: this.state.blockHeight,
            ...
            borderRadius: this.state.blockWidth / 2,
          }}
        />
